...
I asked Siobhan about the X's in front of time points and the differences we see in measured values per day between experiments.

*The Xs in front of time points are an artifact of when I processed data in R— since it doesn’t allow column names to begin with numbers it sticks an X in front of ones that do. Removing the Xs and continuing with the analysis as you did is correct.*

*I will talk to Geoff about the different numbers of time points and get back to you on that.* one
