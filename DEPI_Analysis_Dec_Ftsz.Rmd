...
We only want to analyze the Ftsz genes in this analysis. And, we only want subline 1 of Col0.

```{r create_Ftsz_subset}
dec_ftsz <- depi_data%>%filter(genotype %in% c("ftsz-dbl", "ftsz2-1", "ftsz2-2" )|(genotype == "Col0"&subline == "1"))

##Confirm that we only have subline 1 of Col0
