...
depi_jan <- read.table("C:/Users/Owner/Documents/Research/Shiu_Lab/Shiu_Lab_R/Data/January_DEPI_Data.txt", sep = ",", header = TRUE, stringsAsFactors = FALSE)
...
```{r}
write.csv(quantile_normalize_all, file = "Clean_DEPI_Data_V2.csv", row.names = FALSE)
```
