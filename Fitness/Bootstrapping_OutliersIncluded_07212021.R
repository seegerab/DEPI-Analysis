...
### Read in the .csv file created in the CreateCSVFiles.R script with quantile normalized values and outliers removed. 
...
### Create TSC heatmap:
ggplot(data = heatmap_data_tsc, aes(x = as.factor(Experiment), y = as.factor(genotype), fill = selectionCoef)) + 
